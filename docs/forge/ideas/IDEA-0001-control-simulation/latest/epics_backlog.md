...
epics:
  ...
  - id: "EPIC-005"
    ...
    in_scope:
      ...
      - "Include execution-order cues per tick as provided by the runtime."
    ...
    out_of_scope:
      ...
      - "Defining execution-order state (owned by EPIC-003)."
    key_artifacts:
      - "Message log"
    dependencies:
      - "EPIC-003"
  ...
  - id: "EPIC-006"
    ...
    out_of_scope:
      ...
      - "Topology/graph visualization (owned by EPIC-007)."
    key_artifacts:
      - "Control view state"
